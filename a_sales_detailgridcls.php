...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->Sales_Number->getSessionValue() <> "") {
			$sMasterFilter = str_replace("@Sales_Number@", ew_AdjustSql($this->Sales_Number->getSessionValue(), "DB"), $sMasterFilter);
		} else {
			$bValidMasterRecord = FALSE;
		}
		if ($bValidMasterRecord) {
		...
		// Sales_Number
		if ($this->Sales_Number->getSessionValue() <> "") {
			$rsnew['Sales_Number'] = $this->Sales_Number->getSessionValue();
		}
