...
var CurrentForm = fstats_houredit = new ew_Form("fstats_houredit", "edit");
...
<form name="fstats_houredit" id="fstats_houredit" class="<?php echo $stats_hour_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-table="stats_hour" data-field="x_Year" name="x_Year" id="x_Year" value="<?php echo ew_HtmlEncode($stats_hour->Year->CurrentValue) ?>">
...
<input type="hidden" data-table="stats_hour" data-field="x_Month" name="x_Month" id="x_Month" value="<?php echo ew_HtmlEncode($stats_hour->Month->CurrentValue) ?>">
...
<input type="hidden" data-table="stats_hour" data-field="x_Date" name="x_Date" id="x_Date" value="<?php echo ew_HtmlEncode($stats_hour->Date->CurrentValue) ?>">
...
<input type="hidden" data-table="stats_hour" data-field="x_Hour" name="x_Hour" id="x_Hour" value="<?php echo ew_HtmlEncode($stats_hour->Hour->CurrentValue) ?>">
...
<button class="btn btn-danger ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $stats_hour_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php // Begin of modification Customize Navigation/Pager Panel, by Masino Sinaga, May 2, 2012 ?>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fstats_houredit.Validate() == true ) { alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fstats_houredit").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
