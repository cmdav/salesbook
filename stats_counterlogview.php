...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["IP_Address"] <> "") {
				$this->IP_Address->setFormValue($_POST["IP_Address"]);
				$this->RecKey["IP_Address"] = $this->IP_Address->FormValue;
...
var CurrentForm = fstats_counterlogview = new ew_Form("fstats_counterlogview", "view");
