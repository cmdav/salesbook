...
var CurrentForm = fa_sales_detaildelete = new ew_Form("fa_sales_detaildelete", "delete");
...
fa_sales_detaildelete.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"ChildFields":["x_Stock_Item"],"FilterFields":[],"Options":[],"Template":""};
fa_sales_detaildelete.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Supplier_Number" class="a_sales_detail_Supplier_Number">
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Stock_Item" class="a_sales_detail_Stock_Item">
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Sales_Quantity" class="a_sales_detail_Sales_Quantity">
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Purchasing_Price" class="a_sales_detail_Purchasing_Price">
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Sales_Price" class="a_sales_detail_Sales_Price">
...
<span id="el<?php echo $a_sales_detail_delete->RowCnt ?>_a_sales_detail_Sales_Total_Amount" class="a_sales_detail_Sales_Total_Amount">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $a_sales_detail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fa_sales_detaildelete.Validate() == true ) { alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fa_sales_detaildelete").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
