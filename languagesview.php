...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["Language_Code"] <> "") {
				$this->Language_Code->setFormValue($_POST["Language_Code"]);
...
flanguagesview.Lists["x__Default[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flanguagesview.Lists["x__Default[]"].Options = <?php echo json_encode($languages->_Default->Options()) ?>;
...
<?php if ($languages->Default_Thousands_Separator->Visible) { // Default_Thousands_Separator ?>
	<tr id="r_Default_Thousands_Separator">
		...
		<td data-name="Default_Thousands_Separator"<?php echo $languages->Default_Thousands_Separator->CellAttributes() ?>>
...
<?php if ($languages->Default_Decimal_Point->Visible) { // Default_Decimal_Point ?>
	<tr id="r_Default_Decimal_Point">
		...
		<td data-name="Default_Decimal_Point"<?php echo $languages->Default_Decimal_Point->CellAttributes() ?>>
...
<?php if ($languages->Default_Currency_Symbol->Visible) { // Default_Currency_Symbol ?>
	<tr id="r_Default_Currency_Symbol">
		...
		<td data-name="Default_Currency_Symbol"<?php echo $languages->Default_Currency_Symbol->CellAttributes() ?>>
...
<?php if ($languages->Default_Money_Thousands_Separator->Visible) { // Default_Money_Thousands_Separator ?>
	<tr id="r_Default_Money_Thousands_Separator">
		...
		<td data-name="Default_Money_Thousands_Separator"<?php echo $languages->Default_Money_Thousands_Separator->CellAttributes() ?>>
...
<?php if ($languages->Default_Money_Decimal_Point->Visible) { // Default_Money_Decimal_Point ?>
	<tr id="r_Default_Money_Decimal_Point">
		...
		<td data-name="Default_Money_Decimal_Point"<?php echo $languages->Default_Money_Decimal_Point->CellAttributes() ?>>
...
<?php if ($languages->Terms_And_Condition_Text->Visible) { // Terms_And_Condition_Text ?>
	<tr id="r_Terms_And_Condition_Text">
		...
		<td data-name="Terms_And_Condition_Text"<?php echo $languages->Terms_And_Condition_Text->CellAttributes() ?>>
...
<?php if ($languages->Announcement_Text->Visible) { // Announcement_Text ?>
	<tr id="r_Announcement_Text">
		...
		<td data-name="Announcement_Text"<?php echo $languages->Announcement_Text->CellAttributes() ?>>
...
<?php if ($languages->About_Text->Visible) { // About_Text ?>
	<tr id="r_About_Text">
		...
		<td data-name="About_Text"<?php echo $languages->About_Text->CellAttributes() ?>>
