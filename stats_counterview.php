	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			// Begin of changes v11.0.6
				...
				$this->Type->setFormValue($_POST["Type"]);
				$this->RecKey["Type"] = $this->Type->FormValue;
			...
			// Begin of changes v11.0.6
				...
				$this->Variable->setFormValue($_POST["Variable"]);
				$this->RecKey["Variable"] = $this->Variable->FormValue;
...
var CurrentForm = fstats_counterview = new ew_Form("fstats_counterview", "view");
