...
var CurrentForm = fa_suppliersupdate = new ew_Form("fa_suppliersupdate", "update");
...
fa_suppliersupdate.Lists["x_Is_Stock_Available"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fa_suppliersupdate.Lists["x_Is_Stock_Available"].Options = <?php echo json_encode($a_suppliers->Is_Stock_Available->Options()) ?>;
...
?>
<form name="fa_suppliersupdate" id="fa_suppliersupdate" class="<?php echo $a_suppliers_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="checkbox" name="u_Supplier_Number" id="u_Supplier_Number" value="1"<?php echo ($a_suppliers->Supplier_Number->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Supplier_Name" id="u_Supplier_Name" value="1"<?php echo ($a_suppliers->Supplier_Name->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Address" id="u_Address" value="1"<?php echo ($a_suppliers->Address->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_City" id="u_City" value="1"<?php echo ($a_suppliers->City->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Country" id="u_Country" value="1"<?php echo ($a_suppliers->Country->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Contact_Person" id="u_Contact_Person" value="1"<?php echo ($a_suppliers->Contact_Person->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Phone_Number" id="u_Phone_Number" value="1"<?php echo ($a_suppliers->Phone_Number->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u__Email" id="u__Email" value="1"<?php echo ($a_suppliers->_Email->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Mobile_Number" id="u_Mobile_Number" value="1"<?php echo ($a_suppliers->Mobile_Number->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Notes" id="u_Notes" value="1"<?php echo ($a_suppliers->Notes->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Balance" id="u_Balance" value="1"<?php echo ($a_suppliers->Balance->MultiUpdate == "1") ? " checked" : "" ?>>
...
<input type="checkbox" name="u_Is_Stock_Available" id="u_Is_Stock_Available" value="1"<?php echo ($a_suppliers->Is_Stock_Available->MultiUpdate == "1") ? " checked" : "" ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $a_suppliers_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div>
	</div>
</div>
</form>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyUpdate(this)'); function alertifyUpdate(obj) { <?php global $Language; ?> if (fa_suppliersupdate.Validate() == true ) { alertify.confirm("<?php echo  $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_suppliersupdate").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
