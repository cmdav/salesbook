...
var CurrentForm = fa_customersview = new ew_Form("fa_customersview", "view");
...
<?php if ($a_customers->Customer_ID->Visible) { // Customer_ID ?>
	<tr id="r_Customer_ID">
		...
		<td data-name="Customer_ID"<?php echo $a_customers->Customer_ID->CellAttributes() ?>>
...
<?php if ($a_customers->Address->Visible) { // Address ?>
	<tr id="r_Address">
		...
		<td data-name="Address"<?php echo $a_customers->Address->CellAttributes() ?>>
...
<?php if ($a_customers->City->Visible) { // City ?>
	<tr id="r_City">
		...
		<td data-name="City"<?php echo $a_customers->City->CellAttributes() ?>>
...
<?php if ($a_customers->Country->Visible) { // Country ?>
	<tr id="r_Country">
		...
		<td data-name="Country"<?php echo $a_customers->Country->CellAttributes() ?>>
...
<?php if ($a_customers->_Email->Visible) { // Email ?>
	<tr id="r__Email">
		...
		<td data-name="_Email"<?php echo $a_customers->_Email->CellAttributes() ?>>
...
<?php if ($a_customers->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		...
		<td data-name="Notes"<?php echo $a_customers->Notes->CellAttributes() ?>>
...
<?php if ($a_customers->Date_Added->Visible) { // Date_Added ?>
	<tr id="r_Date_Added">
		...
		<td data-name="Date_Added"<?php echo $a_customers->Date_Added->CellAttributes() ?>>
...
<?php if ($a_customers->Added_By->Visible) { // Added_By ?>
	<tr id="r_Added_By">
		...
		<td data-name="Added_By"<?php echo $a_customers->Added_By->CellAttributes() ?>>
...
<?php if ($a_customers->Date_Updated->Visible) { // Date_Updated ?>
	<tr id="r_Date_Updated">
		...
		<td data-name="Date_Updated"<?php echo $a_customers->Date_Updated->CellAttributes() ?>>
...
<?php if ($a_customers->Updated_By->Visible) { // Updated_By ?>
	<tr id="r_Updated_By">
		...
		<td data-name="Updated_By"<?php echo $a_customers->Updated_By->CellAttributes() ?>>
