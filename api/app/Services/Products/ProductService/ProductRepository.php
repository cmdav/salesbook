    ...
    public function transformProduct($product){
        ...
        //    // "unit" => optional($product->measurement)->unit,
             //  "cat_id" => optional($product->subCategory)->category_id,
              "category_name" => optional($product->subCategory)->category ? optional($product->subCategory->category)->category_name : null,
        //     "measurement_id" => optional($product->measurement)->measurement_name,
              "product_sub_category_name" => optional($product->subCategory)->sub_category_name,
            "vat" => $product->vat,
        //     "selling_price" => "",
        //     "supplier_fullname" => "",
        //     "supplier_number" => "",
