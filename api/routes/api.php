...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::group(['prefix' => 'v1'], function () {
        ...
        Route::resource('product-measurements', App\Http\Controllers\Products\ProductMeasurementController::class);
        Route::resource('measurement-groups', App\Http\Controllers\Products\MeasurementGroupController::class);
