...
var CurrentForm = fa_suppliersdelete = new ew_Form("fa_suppliersdelete", "delete");
...
fa_suppliersdelete.Lists["x_Is_Stock_Available"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fa_suppliersdelete.Lists["x_Is_Stock_Available"].Options = <?php echo json_encode($a_suppliers->Is_Stock_Available->Options()) ?>;
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Supplier_Number" class="a_suppliers_Supplier_Number">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Supplier_Name" class="a_suppliers_Supplier_Name">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Contact_Person" class="a_suppliers_Contact_Person">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Phone_Number" class="a_suppliers_Phone_Number">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Mobile_Number" class="a_suppliers_Mobile_Number">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Balance" class="a_suppliers_Balance">
...
<span id="el<?php echo $a_suppliers_delete->RowCnt ?>_a_suppliers_Is_Stock_Available" class="a_suppliers_Is_Stock_Available">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $a_suppliers_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fa_suppliersdelete.Validate() == true ) { alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fa_suppliersdelete").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
