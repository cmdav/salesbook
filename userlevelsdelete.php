...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_User_Level_ID" class="userlevels_User_Level_ID">
...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_User_Level_Name" class="userlevels_User_Level_Name">
