...
flanguagesdelete.Lists["x__Default[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flanguagesdelete.Lists["x__Default[]"].Options = <?php echo json_encode($languages->_Default->Options()) ?>;
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Language_Code" class="languages_Language_Code">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Language_Name" class="languages_Language_Name">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages__Default" class="languages__Default">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Site_Logo" class="languages_Site_Logo">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Site_Title" class="languages_Site_Title">
