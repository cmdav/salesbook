...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function EditRow() {
		...
		if ($this->Sales_Number->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`Sales_Number` = '" . ew_AdjustSql($this->Sales_Number->CurrentValue, $this->DBID) . "')";
...
var CurrentForm = fa_salesedit = new ew_Form("fa_salesedit", "edit");
...
fa_salesedit.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fa_salesedit.Lists["x_Discount_Type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fa_salesedit.Lists["x_Discount_Type"].Options = <?php echo json_encode($a_sales->Discount_Type->Options()) ?>;
...
<form name="fa_salesedit" id="fa_salesedit" class="<?php echo $a_sales_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-table="a_sales" data-field="x_Sales_ID" name="x_Sales_ID" id="x_Sales_ID" value="<?php echo ew_HtmlEncode($a_sales->Sales_ID->CurrentValue) ?>">
...
<button class="btn btn-danger ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $a_sales_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php // Begin of modification Customize Navigation/Pager Panel, by Masino Sinaga, May 2, 2012 ?>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fa_salesedit.Validate() == true ) { alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_salesedit").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
