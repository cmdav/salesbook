...
var CurrentForm = fa_sales_detailview = new ew_Form("fa_sales_detailview", "view");
...
fa_sales_detailview.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"ChildFields":["x_Stock_Item"],"FilterFields":[],"Options":[],"Template":""};
fa_sales_detailview.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($a_sales_detail->Sales_ID->Visible) { // Sales_ID ?>
	<tr id="r_Sales_ID">
		...
		<td data-name="Sales_ID"<?php echo $a_sales_detail->Sales_ID->CellAttributes() ?>>
