...
var CurrentForm = fa_purchases_detailview = new ew_Form("fa_purchases_detailview", "view");
...
fa_purchases_detailview.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"ChildFields":["x_Stock_Item"],"FilterFields":[],"Options":[],"Template":""};
fa_purchases_detailview.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":true,"AutoFill":false,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($a_purchases_detail->Purchase_ID->Visible) { // Purchase_ID ?>
	<tr id="r_Purchase_ID">
		...
		<td data-name="Purchase_ID"<?php echo $a_purchases_detail->Purchase_ID->CellAttributes() ?>>
