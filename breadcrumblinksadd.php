		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "breadcrumblinkslist.php")
						$sReturnUrl = $this->AddMasterUrl($this->GetListUrl()); // List page, return to list page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "breadcrumblinksview.php")
...
var CurrentForm = fbreadcrumblinksadd = new ew_Form("fbreadcrumblinksadd", "add");
...
?>
<form name="fbreadcrumblinksadd" id="fbreadcrumblinksadd" class="<?php echo $breadcrumblinks_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-table="breadcrumblinks" data-field="x_Page_Title" name="x_Page_Title" id="x_Page_Title" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($breadcrumblinks->Page_Title->getPlaceHolder()) ?>" value="<?php echo $breadcrumblinks->Page_Title->EditValue ?>"<?php echo $breadcrumblinks->Page_Title->EditAttributes() ?>>
</span>
...
<input type="text" data-table="breadcrumblinks" data-field="x_Page_URL" name="x_Page_URL" id="x_Page_URL" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($breadcrumblinks->Page_URL->getPlaceHolder()) ?>" value="<?php echo $breadcrumblinks->Page_URL->EditValue ?>"<?php echo $breadcrumblinks->Page_URL->EditAttributes() ?>>
</span>
...
<input type="text" data-table="breadcrumblinks" data-field="x_Lft" name="x_Lft" id="x_Lft" size="30" placeholder="<?php echo ew_HtmlEncode($breadcrumblinks->Lft->getPlaceHolder()) ?>" value="<?php echo $breadcrumblinks->Lft->EditValue ?>"<?php echo $breadcrumblinks->Lft->EditAttributes() ?>>
</span>
...
<input type="text" data-table="breadcrumblinks" data-field="x_Rgt" name="x_Rgt" id="x_Rgt" size="30" placeholder="<?php echo ew_HtmlEncode($breadcrumblinks->Rgt->getPlaceHolder()) ?>" value="<?php echo $breadcrumblinks->Rgt->EditValue ?>"<?php echo $breadcrumblinks->Rgt->EditAttributes() ?>>
</span>
...
<button class="btn btn-danger ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $breadcrumblinks_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fbreadcrumblinksadd.Validate() == true ) { alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fbreadcrumblinksadd").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
