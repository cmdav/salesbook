...
var CurrentForm = fbreadcrumblinksdelete = new ew_Form("fbreadcrumblinksdelete", "delete");
...
<span id="el<?php echo $breadcrumblinks_delete->RowCnt ?>_breadcrumblinks_Page_Title" class="breadcrumblinks_Page_Title">
...
<span id="el<?php echo $breadcrumblinks_delete->RowCnt ?>_breadcrumblinks_Page_URL" class="breadcrumblinks_Page_URL">
...
<span id="el<?php echo $breadcrumblinks_delete->RowCnt ?>_breadcrumblinks_Lft" class="breadcrumblinks_Lft">
...
<span id="el<?php echo $breadcrumblinks_delete->RowCnt ?>_breadcrumblinks_Rgt" class="breadcrumblinks_Rgt">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $breadcrumblinks_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fbreadcrumblinksdelete.Validate() == true ) { alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fbreadcrumblinksdelete").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
