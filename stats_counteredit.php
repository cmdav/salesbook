...
var CurrentForm = fstats_counteredit = new ew_Form("fstats_counteredit", "edit");
...
<form name="fstats_counteredit" id="fstats_counteredit" class="<?php echo $stats_counter_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-table="stats_counter" data-field="x_Type" name="x_Type" id="x_Type" value="<?php echo ew_HtmlEncode($stats_counter->Type->CurrentValue) ?>">
...
<input type="hidden" data-table="stats_counter" data-field="x_Variable" name="x_Variable" id="x_Variable" value="<?php echo ew_HtmlEncode($stats_counter->Variable->CurrentValue) ?>">
...
<button class="btn btn-danger ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $stats_counter_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php // Begin of modification Customize Navigation/Pager Panel, by Masino Sinaga, May 2, 2012 ?>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fstats_counteredit.Validate() == true ) { alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fstats_counteredit").submit(); } }).set("title", "<?php echo $Language->Phrase('AlertifyConfirm'); ?>").set("defaultFocus", "cancel").set('oncancel', function(closeEvent){ alertify.error('<?php echo $Language->Phrase('AlertifyCancel'); ?>');}).set('labels', {ok:'<?php echo $Language->Phrase("MyOKMessage"); ?>!', cancel:'<?php echo $Language->Phrase("MyCancelMessage"); ?>'}); } return false; }
</script>
<?php } ?>
